...
func (c *listWorkersCommand) listWorkers(ctx context.Context, cmd *cli.Command) error {
	...
	workerPoolID := cmd.String(flagPoolIDNamed.Name)
...
func (c *drainWorkerCommand) drainWorker(ctx context.Context, cmd *cli.Command) error {
	workerID := cmd.String(flagWorkerID.Name)
	workerPoolID := cmd.String(flagPoolIDNamed.Name)
	waitUntilDrained := cmd.Bool(flagWaitUntilDrained.Name)
...
func (c *undrainWorkerCommand) undrainWorker(ctx context.Context, cmd *cli.Command) error {
	workerID := cmd.String(flagWorkerID.Name)
	workerPoolID := cmd.String(flagPoolIDNamed.Name)
...
func (c *cycleWorkersCommand) cycleWorkers(ctx context.Context, cmd *cli.Command) error {
	var mutation cycleWorkerMutation
	variables := map[string]interface{}{
		"workerPoolId": graphql.ID(cmd.String(flagPoolIDNamed.Name)),
	}
